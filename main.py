...
def add_friend(): #function to add friend
    ...
    firstname=raw_input('What is your friend\'s name : ' )
...
frnd1=Spy('Rahul','Mr.',20,6.8)
frnd2=Spy('Rashmi','Ms.',22,4.3)
...
if spy_reply.upper()=='N':
    ...
    spy=Spy('','',0,0.0) #class to store spydetails
    ...
    if spy.name.isspace(): #to check for space input
        ...
        if spy.sal == 'Mr.' or spy.sal == 'Ms.': #using if to check the condition
